...
| 7             | Sensorless Home          | 0: direction (0 = negative, 1 = positive)<br>1–7: optional | Perform sensorless homing                         | No               | -               | Not Yet     |
...
| 12            | Stallguard Threshold     | 0–1: int16 threshold<br>2–7: optional                      | Threshold for stall detection                     | Yes              | 10              | Not Yet     |
...
| 16            | Position Speed           | 0–3: float speed<br>4–7: optional                          | Max speed for position moves (deg/sec)            | Yes              | 1080.0          | Yes         |
...
| 22            | TBC
| 23            | Reset to Default         | 0–7: optional                                              | Restore node to default configuration             | No              | -               | Not Yet     |
| 24            | Save Config              | 0–7: optional                                              | Save current configuration to non-volatile memory | No              | -               | Yes         |
| 25            | Set Node ID              | 0–1: uint16 Node ID<br>2–7: optional                       | Set NODE ID of all devices on bus <br> Ensure only 1 device is on bus to avoid collisions | -              | -               | Not Yet     |
| 26            | AUX Connector           | 0–1: AUX1 Function (uint16)<br>2–3: AUX1 Value (uint16)<br>4–5: AUX2 Function (uint16)<br>6–7: AUX2 Value (uint16) | Each pin configured independently. Serial mode (1) requires both pins set to function 1. See AUX Connector section. | Yes            | 0 (Disabled)    | Partially   |
